...
(function($,opt){
	...
	$(document).off('mouseenter.form_select');
	$(document).off('keydown.form_select');

	//设置焦点
	$(document).on('click.form_select',selectSelector,function(){
		var $thisSelect = $(this);
	...
	//选项开关
	$(document).on('click.form_select',selectSwitchBtnSelector,function(e){
	...
	//鼠标hover option
	$(document).on("mouseenter.form_select",selectSelector+' '+selectOptionSelector,function(){
		var $thisOption = $(this),
	...
	//单击选值
	$(document).on("click.form_select",selectSelector+' '+selectOptionSelector,function(){
		var $thisOption = $(this),
			$thisSelect = $thisOption.parents(selectSelector),
